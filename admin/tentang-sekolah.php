                ...
                <div class="box">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <img src="../admin/uploads/identitas/<?= $d->foto_sekolah ?>" width="200px" class="image">
                        ...
                        <?php
                            ...
                            if(isset($_POST['submit'])){
                                ...
                                //menampung data dan validasi foto Sekolah
                                if($_FILES['foto_baru']['name'] != ''){
                                    ...
                                    if(!in_array($formatfile, $allowtedype)){
                                        ...
                                        if(file_exists($dirupload.$_POST['foto_lama'])){
                                            unlink($dirupload.$_POST['foto_lama']);
                                        }
