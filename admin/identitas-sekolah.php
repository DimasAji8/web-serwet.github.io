            ...
            <div class="container">
                ...
                <div class="box">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Logo</label>
                            <img src="../admin/uploads/identitas/<?= $d->logo ?>" width="200px" class="image">
                        ...
                        <div class="form-group">
                            <label>favicon</label>
                            <img src="../admin/uploads/identitas/<?= $d->favicon ?>" width="50px"class="image">
                        ...
                        <?php
                            ...
                            if(isset($_POST['submit'])){
                                ...
                                //menampung data dan validasi logo
                                if($_FILES['logo_baru']['name'] != ''){
                                    ...
                                    $dirupload = "../admin/uploads/identitas/";

                                    $formatfile_logo = pathinfo($filename_logo, PATHINFO_EXTENSION);
                                    $rename_logo     = 'logo'.time().'.'.$formatfile_logo;
                                    

                                    $allowtedype_logo = array('png','jpg','jpeg','gif');

                                    if(!in_array($formatfile_logo, $allowtedype_logo)){
                                        ...
                                        if(file_exists($dirupload.$_POST['logo_lama'])){
                                            unlink($dirupload.$_POST['logo_lama']);
                                        }


                                        $upload =  move_uploaded_file($tmpname_logo, $dirupload.$rename_logo);
                                 ...
                                 //menampung data dan validasi favicon
                                 if($_FILES['favicon_baru']['name'] != ''){
                                    ...
                                    $allowtedype_favicon = array('png','jpg','jpeg','gif');

                                    if(!in_array($formatfile_favicon, $allowtedype_favicon)){
                                        ...
                                        if(file_exists($dirupload.$_POST['favicon_lama'])){
                                            unlink($dirupload.$_POST['favicon_lama']);
                                        }


                                        $upload =  move_uploaded_file($tmpname_favicon, $dirupload.$rename_favicon);
