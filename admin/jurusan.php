                       ...
                       <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $p['nama'] ?></td>
                                <td><?= $p['keterangan'] ?></td>
                                <td><img src="../admin/uploads/jurusan/<?= $p['gambar'] ?>"width="100px"></td>
                                <td>
                                    <a href="edit-jurusan.php?id=<?= $p['id']?>" title="Edit Data" class="text-blue"><i class="fa fa-edit"></i></a> |
                                    <a href="hapus.php?idjurusan=<?= $p['id']?>"onclick="return confirm('Yakin Ingin Menghapus Data?')" title="Hapus Data" class="text-red"><i class="fa fa-times"></i></a>
                                </td>
                            </tr>
                            <?php }}else{ ?>
                                <tr>
